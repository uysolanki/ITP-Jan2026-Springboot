...
public class ProductController {
	...
	ResponseEntity<?> updateProduct(@PathVariable int id, @RequestBody ProductDTO productDTO){
		try {
			productService.updateProduct(id, productDTO);
			return new ResponseEntity<String>("Product of id " + id + " has been updated",
					HttpStatus.OK);
		} catch (Exception e) {
	...
	@PutMapping("/updateProductWithValidationAndExceptionHandling/{id}")
	ResponseEntity<?> updateProductWithValidationAndExceptionHandling(@PathVariable int id,@Valid @RequestBody ProductDTO productDTO, BindingResult bindingResult){
